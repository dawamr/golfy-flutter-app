...
class _EmailLoginWidgetState extends State<EmailLoginWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().firstOnboarding ? true : false) {
        if (FFAppState().refreshToken != '') {
          _model.apiResultffd = await CmsGroup.refreshTokenCall.call(
            refreshToken: FFAppState().refreshToken,
          );
          if ((_model.apiResultffd?.succeeded ?? true)) {
