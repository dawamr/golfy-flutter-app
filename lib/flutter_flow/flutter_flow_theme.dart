...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF2AC769);
  ...
  late Color secondaryText = const Color(0xFF9B9B9B);
  late Color primaryBackground = const Color(0xFFF5FBFB);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x0E2AC769);
  late Color accent2 = const Color(0x7A202020);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color accent1 = const Color(0x072AC769);
  late Color accent2 = const Color(0x7A202020);
  late Color accent3 = const Color(0x4D984BB6);
  late Color accent4 = const Color(0x00101818);
  late Color success = const Color(0xFF16857B);
  late Color warning = const Color(0xFFF3C344);
  late Color error = const Color(0xFFC4454D);
  late Color info = const Color(0xFFFFFFFF);
